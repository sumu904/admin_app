...
class CategorizedOrderModel {
  ...
  final List<OrderModel> processing;
  final List<OrderModel> handover;
  final List<OrderModel> outForDelivery;
  ...
  factory CategorizedOrderModel.fromJson(Map<String, dynamic> json) {
    return CategorizedOrderModel(
        pending:
            json['pending'].map((item) => OrderModel.fromJson(item)).toList(),
        processing: json['processing']
            .map((item) => OrderModel.fromJson(item))
            .toList(),
        handover:
            json['handover'].map((item) => OrderModel.fromJson(item)).toList(),
  ...
  Map<String, dynamic> toJson() {
    ...
    data['processing'] = processing.map((v) => v.toJson()).toList();
    data['handover'] = handover.map((v) => v.toJson()).toList();
    data['outForDelivery'] = outForDelivery.map((v) => v.toJson()).toList();
